# Generated by Django 4.2.5 on 2024-04-14 17:17
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AlterField(
            model_name='women',
            name='slug',
            field=models.SlugField(max_length=255, unique=True, validators=[django.core.validators.MinLengthValidator(5, message='Слишком мало символов, минимальный порог 5'), django.core.validators.MaxLengthValidator(100)], verbose_name='Slug'),
        ),
        migrations.AlterField(
            model_name='women',
            name='tagies',
